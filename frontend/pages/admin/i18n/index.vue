<template>
  <div class="container pt-2 flex justify-star items-center w-full">
    <div class="w-full">
      <h1
        class="mx-auto text-xl font-medium tracking-tight text-primary pt-4 pb-2"
      >
        <span class="relative">
  ...
  <div class="container py-5">
    <div class="w-full grid-cols-fill-15 grid gap-2">
      ...
      <div
        v-for="translation in translationStore.translations"
        class="bg-solid-foreground border-input border hover:border-solid rounded-md drop-shadow p-3 flex flex-col justify-between gap-2 cursor-pointer"
        @click="openEditModal(translation.id)"
      >
        <div class="flex flex-col gap-2">
          <span
            class="border border-solid w-fit px-2 text-xs rounded-full py-1 leading-none italic"
            >{{ translation.key }}</span
          >
        ...
        <div class="flex justify-end items-center">
          <span
            class="bg-solid text-solid-foreground w-fit px-2 text-xs rounded-full font-semibold py-1 leading-none"
          >
  ...
  <TranslationsEditModal
    :translationId="editTranslationId"
    @close="editTranslationId = false"
  ></TranslationsEditModal>
  <TranslationsAddModal
