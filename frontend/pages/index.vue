<template>
  <div class="container text-center min-h-[80vh] items-center justify-center flex flex-col ">
    <h1 class="max-w-4xl mx-auto text-fluid-xl font-medium tracking-tight text-primary leading-none">
      <span class="relative"><span class="underline">{{ $t("index.title.0") }}</span></span>
      {{ $t("index.title.1") }}
    </h1>
